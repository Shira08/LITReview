...
urlpatterns = [
    ...
    path('update-review/<int:id>/<int:review_id>', review.views.update_review_response, name='update-review'),
    path('review/delete/<int:id>/', review.views.review_delete, name='review_delete'),
